...
// @match       https://waze.com/*editor*
// @downloadURL https://davidsl4.github.io/WMEScripts/import-venues.user.js
...
function useLocalStorage(key, initialValue) {
    ...
    const initialStoredValue = (0,react_module_wrapper.useMemo)(() => getJSONFromStorage(key), [key]);
...
function StoredListsContextProvider({
  ...
  const [lists, setLists] = useLocalStorage(storageKey, []);
